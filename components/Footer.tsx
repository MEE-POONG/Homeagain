        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-md-6 text-center text-md-end">
                    Designed By <a className="border-bottom" href="https://htmlcodex.com">Me Promp Technologo Company Limited.</a> Distributed By <a href="https://themewagon.com">ThemeMeepoong</a>
                </div>
            </div>
        </div>
    </div>
