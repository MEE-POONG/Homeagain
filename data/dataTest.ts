...
export const howtoDonate = [
    ...
    // { id: '2', language: 'EN', tital1: 'You can donate pet food and other items needed to care for animals as follows.', list1: 'donated items (continuous use) * Accepting donations for all brands *', list2: 'Dog and cat food (all brands) for adult dogs', list3: 'Food pellets, all flavors, no brand restrictions', list4: 'Absorbent pads, like cage padsง', list5: 'Cat litter (for cats to excrete)', list6: 'Dishwashing detergent, medium and large garbage bags', list7: 'Dog Bathing Shampoo', list8: 'You can donate items other than the items listed above. which the joint donation You can contact the staff of the foundation Khun Nut: 098-241-8799 to proceed.' },

]

export const donation = [
    { id: '1', language: 'TH', tital2: 'นอกจากบริจาคสิ่งของจำเป็น ท่านสามารถร่วมบริจาคเป็นเงิน เพื่อสมทบทุนในการดูแลสุนัข ที่อยู่ในการอุปถัมภ์ของมูลนิธิได้', list1: 'ช่องทางการโอนเงิน', account: 'บัญชีธนาคารกรุงไทย', accName: 'มูลนิธิบ้านหลังใหม่ Home Again Doggies Foundation', accNo: '679-3-47783-8 ', swiftcode: 'KRTHTHBK' },
    // { id: '2', language: 'EN', tital2: 'In addition to donating essential items You can make a monetary donation. to raise funds for the care of the dogs under the patronage of the foundation', list1: '', list2: 'Krung Thai Bank account', list3: 'ชื่อบัญชี', list4: 'มูลนิธิบ้านหลังใหม่ Home Again Doggies Foundation', list5: 'Account No.', list6: '679-3-47783-8 ', list7: 'KRTHTHBK', list8: '' },
