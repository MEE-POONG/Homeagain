                        ...
                        <div className="row lv-1 align-items-center">
                            <div className="col-xl-6 col-lg-6 col-md-12">
                                <div className="d-flex people-list ADVISOR px-3 py-4 my-3">
                                    <Image className="rounded-circle" src="https://imagedelivery.net/QZ6TuL-3r02W7wQjQrv5DA/fb9efe15-dde2-45d7-2d34-65446db0e700/300" />
                            ...
                            <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-xs-6 col-md-6 col-sm-6">
                                <div className="p-2 w-100 people-list px-3 py-4 my-3" >
                                    ...
                                    <Image className="rounded-circle" src="https://imagedelivery.net/QZ6TuL-3r02W7wQjQrv5DA/8e44fcbf-3a60-4941-0e69-03b080ad4800/300" />
                            ...
                            <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-xs-6 col-md-6 col-sm-6">
                                <div className="p-2 w-100 people-list px-3 py-4 my-3">
                                    ...
                                    <Image className="rounded-circle" src="https://imagedelivery.net/QZ6TuL-3r02W7wQjQrv5DA/230ea2e9-44c9-434f-96ec-649076385900/300" />
                                ...
                                <div className="row  lv-2">
                                    <div className="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                        <div className="p-2 w-100 people-list px-3 py-4 my-3" >
                                            ...
                                            <Image className="rounded-circle" src="https://imagedelivery.net/QZ6TuL-3r02W7wQjQrv5DA/00b98078-2f76-4e24-abdd-d788e11a7700/300" />
                                    ...
                                    <div className="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                        <div className="p-2 w-100 people-list px-3 py-4 my-3" >
                                            ...
                                            <Image className="rounded-circle" src="https://imagedelivery.net/QZ6TuL-3r02W7wQjQrv5DA/87888cc2-a8b6-488e-2fa1-59cb505ee700/300" />
                                ...
                                <div className="row lv-3">
                                    <div className="col-lg-3 col-md-4 col-sm-6 col-xs-6">
                                        <div className="p-2 people-list px-3 py-4 my-3">
                                            ...
                                            <Image className="rounded-circle" src="https://imagedelivery.net/QZ6TuL-3r02W7wQjQrv5DA/30bea057-8045-44e8-1254-574b24cda800/300" />
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6 col-xs-6">
                                        <div className="p-2 people-list px-3 py-4 my-3">
                                            ...
                                            <Image className="rounded-circle" src="https://imagedelivery.net/QZ6TuL-3r02W7wQjQrv5DA/408dd58d-54ac-4e51-70eb-396d54ca3f00/300" />
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6 col-xs-6">
                                        <div className="p-2 people-list px-3 py-4 my-3">
                                            ...
                                            <Image className="rounded-circle" src="https://imagedelivery.net/QZ6TuL-3r02W7wQjQrv5DA/1b46085c-1d13-4c24-64d1-d3168bd9ef00/300" />
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6 col-xs-6">
                                        <div className="p-2 people-list px-3 py-4 my-3">
                                            <h6 className="bold mb-0">DIRECTOR</h6>
                                            <p className="bold mb-0"><span>กรรมการมูลนิธิบ้านหลังใหม่</span></p>
                                            <Image className="rounded-circle" src="https://imagedelivery.net/QZ6TuL-3r02W7wQjQrv5DA/87a0e2b3-543d-425d-df37-8f7abb1e1400/300" />
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6 col-xs-6">
                                        <div className="p-2 people-list px-3 py-4 my-3">
                                            ...
                                            <Image className="rounded-circle" src="https://imagedelivery.net/QZ6TuL-3r02W7wQjQrv5DA/e76f3435-3e41-4f79-3300-dc91d6571000/300" />
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6 col-xs-6">
                                        <div className="p-2 people-list px-3 py-4 my-3">
                                            <h6 className="bold mb-0">PUCLIC RELATION</h6>
                                            <p className="bold mb-0"><span>ฝ่ายประชาสมพันธ์</span></p>
                                            <Image className="rounded-circle" src="https://imagedelivery.net/QZ6TuL-3r02W7wQjQrv5DA/d3130374-84ad-41ba-2aa2-15e293425100/300" />
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6 col-xs-6">
                                        <div className="p-2 people-list px-3 py-4 my-3">
                                            <h6 className="bold mb-0">PUCLIC RELATION</h6>
                                            <p className="bold mb-0"><span>ฝ่ายประชาสมพันธ์</span></p>
                                            <Image className="rounded-circle" src="https://imagedelivery.net/QZ6TuL-3r02W7wQjQrv5DA/8dc94b37-623b-41ce-9214-fa6e23596e00/300" />
                                    ...
                                    <div className="col-lg-3 col-md-4 col-sm-6 col-xs-6">
                                        <div className="p-2 people-list px-3 py-4 my-3">
                                            ...
                                            <Image className="rounded-circle" src="https://imagedelivery.net/QZ6TuL-3r02W7wQjQrv5DA/98d3128c-7d0b-42dd-4767-4794ee05c000/300" />
